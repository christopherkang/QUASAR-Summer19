    ...
    operation _ApplyJordanWignerPQTerm_ (term : GeneratorIndex, stepSize : Double, extraParityQubits : Qubit[], qubits : Qubit[]) : Unit {
        ...
        body (...) {
            ...
            for (idxOp in IndexRange(ops)) {
                ...
                // Message($"PQterm | Qubit {idxFermions[0]}-{idxFermions[1]} + parity | {angle} | {ops[idxOp]}");
            }
        }
        ...
        body (...) {
            ...
            for (idxOp in IndexRange(ops)) {
                ...
                if (IsNotZero(v0123[idxOp % 4])) {
                    ...
                    Message($"0123term | Qubit {idxFermions[0]}-{idxFermions[1]}, {idxFermions[2]}-{idxFermions[3]} | {angle * v0123[idxOp % 4]} | {ops[idxOp]}");
                }
            }
        }

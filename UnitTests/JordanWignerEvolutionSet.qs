...
namespace Microsoft.Quantum.Chemistry.JordanWigner {
    ...
    operation _ApplyJordanWignerZTerm_ (term : GeneratorIndex, stepSize : Double, qubits : Qubit[]) : Unit {
        body (...) {
            ...
            Message($"Zterm | {idxFermions[0]} | {angle}");
        }
    ...
    operation _ApplyJordanWignerZZTerm_ (term : GeneratorIndex, stepSize : Double, qubits : Qubit[]) : Unit {
        ...
        body (...) {
            ...
            Message($"ZZterm | {idxFermions[0]}, {idxFermions[1]} | {angle}");
        }
    ...
    operation _ApplyJordanWignerPQandPQQRTerm_ (term : GeneratorIndex, stepSize : Double, qubits : Qubit[]) : Unit {
        body (...) {
            ...
            if (Length(idxFermions) == 2) {
                ...
                // Message($"PQterm+X | {idxFermions[0]}, {idxFermions[1]} | {angle}");
                // Message($"PQterm+Y | {idxFermions[0]}, {idxFermions[1]} | {angle}");

                Message($"PQterm+X | {idxFermions} | {angle}");
                Message($"PQterm+Y | {idxFermions} | {angle}");
                ...
                if (idxFermions[0] < qubitQidx and qubitQidx < idxFermions[3]) {
                    ...
                    Message($"PQQRterm+X | {idxFermions[0]}, {idxFermions[3]}, {qubitQidx} | {angle}");
                    Message($"PQQRterm+Y | {idxFermions[0]}, {idxFermions[3]}, {qubitQidx} | {angle}");
                    ...
                    Message($"PQQR_Parityterm+X | {idxFermions[0]}, {idxFermions[3]}, {qubitQidx} | {angle}");
                    Message($"PQQR_Parityterm+Y | {idxFermions[0]}, {idxFermions[3]}, {qubitQidx} | {angle}");
        ...
        body (...) {
            ...
            for (idxOp in 0..Length(ops) - 1) {
                ...
                if (IsNotZero(v0123[idxOp % 4])) {
                    ...
                    Message($"0123term+{idxOp} | {idxFermions[0]}, {idxFermions[1]}, {idxFermions[2]}, {idxFermions[3]} | {angle * v0123[idxOp % 4]} | {ops[idxOp]}");
                }
            }
        }
